...
flowchart TD
    ...
    Mod2 --> T12["Topic 12: VPS"]:::network
    Mod2 --> T15["Topic 15: Firewalls"]:::network
    Mod2 --> T46["Topic 46: Networking (ip/ss)"]:::network
    ...
    Mod4 --> T39["filters (cut/sort/uniq)"]:::command
    Mod4 --> T40["redirection (>, >>, <, 2>)"]:::command
    Mod4 --> T41["unix tools (find/xargs/curl)"]:::command
    Mod4 --> T42["regex patterns (grep -E)"]:::command
    Mod4 --> T44["file security (SUID/chattr)"]:::command
    Mod4 --> T47["vi editor (Modes/Commands)"]:::command
```
...
- **Topic 22:** 📣 [[Kali Linux Command cat (Concatenate)|Linux Command: cat (Concatenate)]]
...
- **Topic 39:** ⚙️ [[Kali Linux Course/Topic 39 - Linux Filters and Text Processing (cut, sort, uniq, wc, tee)|Linux Filters & Text Processing (cut, sort, uniq, wc, tee)]]
- **Topic 40:** 🚰 [[Kali Linux Course/Topic 40 - Linux IO Redirection and File Descriptors (stdout, stderr, stdin, dev-null)|Linux I/O Redirection & File Descriptors (stdout, stderr, stdin, dev-null)]]
- **Topic 41:** 🛠️ [[Kali Linux Course/Topic 41 - Advanced Unix Utilities (find, xargs, curl, wget, tar)|Advanced Unix Utilities (find, xargs, curl, wget, tar)]]
- **Topic 42:** 🔍 [[Kali Linux Course/Topic 42 - Linux Regular Expressions (Regex) and Pattern Matching (grep -E, egrep)|Linux Regular Expressions (Regex) & Matching (grep -E, egrep)]]
- **Topic 43:** 👤 [[Kali Linux Course/Topic 43 - Linux User and Group Management (useradd, usermod, passwd, etc-passwd, etc-shadow)|Linux User & Group Management (useradd, usermod, passwd, /etc/passwd, /etc/shadow)]]
- **Topic 44:** 🛡️ [[Kali Linux Course/Topic 44 - Advanced Linux File Security (SUID, SGID, Sticky Bit, chattr, ACLs)|Advanced Linux File Security (SUID, SGID, Sticky Bit, chattr, ACLs)]]
